...
avgtime_consData = mean(consData,1)';          stderr_ConsData     = (std(consData))/sqrt(4);    
avgtime_alpaDepData = mean(alpahDepData,1)';   stderr_alpaDepData  = (std(alpahDepData))/sqrt(8);
avgtime_alphaIndData = mean(alphaIndData,1)';  stderr_alphaIndData = (std(alphaIndData))/sqrt(4);
average_alphaPowerAllTrials = mean(alphaPowerAllTrial,1); stderr_alphaPowerAllTrial = (std(alphaPowerAllTrial))/sqrt(16);
