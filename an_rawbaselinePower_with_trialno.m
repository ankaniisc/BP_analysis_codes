...
figure('name','Raw baseline power  vs. trialno');
...
xlabel('TrialNumber','FontSize',8,'FontWeight','bold','Color','k'); ylabel('Raw baseline power ','FontSize',8,'FontWeight','bold','Color','k');
...
xlabel('TrialNumber','FontSize',12,'FontWeight','bold','Color','k'); ylabel('Raw baseline power ','FontSize',12,'FontWeight','bold','Color','k');
title('Raw baseline power  vs. trialno','FontSize',14,'FontWeight','bold','Color','k');
...
saveas(gca,'Raw baseline power  vs. trialno.png','png');
