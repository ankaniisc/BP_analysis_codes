...
figure('name','Change in raw baseline power vs time');
...
xlabel('Time(sec)','FontSize',8,'FontWeight','bold','Color','k'); ylabel('Raw power during baseline ','FontSize',8,'FontWeight','bold','Color','k');
subplot(2,3,2);
...
xlabel('Time(sec)','FontSize',12,'FontWeight','bold','Color','k'); ylabel('Raw power during baseline ','FontSize',12,'FontWeight','bold','Color','k');
title('Raw power during baseline  vs. time (average across all trials)','FontSize',14,'FontWeight','bold','Color','k');
